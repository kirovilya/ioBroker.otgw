...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new otgw name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/otgw.png')) {
        fs.renameSync(__dirname + '/admin/otgw.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/otgw.html')) {
        fs.renameSync(__dirname + '/widgets/otgw.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/otgw/js/otgw.js')) {
        fs.renameSync(__dirname + '/widgets/otgw/js/otgw.js', __dirname + '/widgets/otgw/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/otgw')) {
        fs.renameSync(__dirname + '/widgets/otgw',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /otgw/g,
        ...
        {
            match: /Otgw/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Otgw'
        },
        {
            match: /Kirov/g,
            replacement: author
